...
COUNTRIES = [
    ("Ethiopia", "Yirgacheffe", "Adado", 6.3056, 38.5721),
    ("Kenya", "Nyeri", "Ichamama", -0.408, 36.952),
    ("Colombia", "Huila", "San Agustin", 1.879, -76.275),
    ("Rwanda", "Nyamasheke", "Kigali", -1.963, 29.807),
    ("Panama", "Boquete", "La Esmeralda", 8.766, -82.434),
    ("Brazil", "Minas Gerais", "Patrocinio", -18.946, -46.993),
    ("Costa Rica", "Tarrazu", "Copey", 9.624, -84.083),
    ("Guatemala", "Huehuetenango", "La Libertad", 15.314, -91.507),
    ("Indonesia", "Gayo", "Takengon", 4.627, 96.848),
    ("Peru", "Cajamarca", "Jaen", -5.708, -78.807),
    ("Burundi", "Kayanza", "Masha", -2.904, 29.629),
    ("Tanzania", "Mbeya", "Mbozi", -9.121, 33.944),
]
...
def seed_data(conn: sqlite3.Connection) -> int:
    ...
    for i in range(60):
        country, region, location, lat, lon = random.choice(COUNTRIES)
